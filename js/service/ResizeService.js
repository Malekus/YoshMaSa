  ...
  Created by berthelot on 031114.
  Based on httpsgithub.comnicamjs-resizeblobmasterresize.js
 
'use strict';


  @ngdoc service
  @name images-resizer.serviceresizeService
  @description
...
angular
    ...
    .service('resizeService', ['$q', '$document', '$window', function ($q, $document, $window) {
        ...
        var isCanvasSupported = !!($document[0].createElement('canvas').getContext && $document[0].createElement('canvas').getContext('2d'));
          ...
          @ngdoc function
          @name #createImage
          @methodOf images-resizer.serviceresizeService
          @description
        ...
        this.resizeImage = function (src, options) {
            ...
            options = {
                ...
                outputFormat options.outputFormat  options.outputFormat  'imagejpeg',
          ...
          @param {string} outputFormat string the format of the output file for example imagejpeg, imagepng,...
